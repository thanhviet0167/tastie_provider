...
const url_provider_add_menu_category = '/v1/api/provider/dashboard/menu-overview/add-menu-category'
...
const url_provider_get_info = '/v1/api/provider/dashboard/get-info'
